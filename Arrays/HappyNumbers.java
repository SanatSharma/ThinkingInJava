...
public class HappyNumbers 
{
	...
	//square the and place the output in an arrayList
	//if out==1, return true, else check if it matches with any other number in the array list
	...
	public static void main(String[] args)
	{
		...
		Boolean b = happyNum(num);
		if(b==true)
		{
			System.out.println(num + "is a happy num");
		}
		else
		{
