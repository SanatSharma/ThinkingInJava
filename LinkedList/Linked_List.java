...
public class Linked_List<AnyType> implements Iterable<AnyType>
{
 ...
 /**
   ...
   *  Complexity: O(n^2)
   */
   public  Linked_List<AnyType> copy1()
   {
      Linked_List<AnyType> twin = new Linked_List<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public Linked_List<AnyType> copy2()
   {
      Linked_List<AnyType> twin = new Linked_List<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
 ...
 /**
   ...
   *  Complewxity: O(n)
   */
   public Linked_List<AnyType> reverse()
   {
      Linked_List<AnyType> list = new Linked_List<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public Linked_List<AnyType> copy3()
   {
      Linked_List<AnyType> twin = new Linked_List<AnyType>();
      Node<AnyType> tmp = head;
...
/*****   Include the main() for testing and debugging  *****/
   ...
   public static void main(String[] args)
   {
      ...
      System.out.println(list);
		...
		Linked_List<String> twin = list.copy3();
