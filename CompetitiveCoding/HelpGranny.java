...
The function "tour" takes 3 params: string[] arrFriends, which is the array 
containing granny's friends, 
string[][] ftwns, which contains friends and towns, 
Map h which gives the distances XOXi.
