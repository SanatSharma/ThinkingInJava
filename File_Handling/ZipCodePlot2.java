...
public class ZipCodePlot2 {
    ...
    public static final int TOKENS_BEFORE_STATE = 2;
    ...
    // skip the first 5 tokens in the line
    ...
    double minLong, double maxLong)  {
        ...
        while(fileScanner.hasNextLine()) {
            Scanner lineScanner = new Scanner(fileScanner.nextLine());
            lineScanner.useDelimiter(",");
            skipTokens(lineScanner, TOKENS_BEFORE_STATE);
